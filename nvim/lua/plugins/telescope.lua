return {
  ...
  keys = {
    -- プラグイン・設定確認（最重要）
    { "<leader>T", "<cmd>Telescope<cr>", desc = "📋 Telescope機能一覧 (All Telescope Features)" },
    { "<leader>tk", "<cmd>Telescope keymaps<cr>", desc = "⌨️  キーマップ一覧 (All Keymaps)" },
    { "<leader>tc", "<cmd>Telescope commands<cr>", desc = "🔧 コマンド一覧 (All Commands)" },
    { "<leader>tp", "<cmd>Lazy<cr>", desc = "🔌 プラグイン管理 (Plugin Manager)" },
    { "<leader>th", "<cmd>Telescope help_tags<cr>", desc = "📖 ヘルプ検索 (Help Documentation)" },
    { "<leader>to", "<cmd>Telescope vim_options<cr>", desc = "⚙️  Vim設定確認 (Vim Options)" },
    { "<leader>ta", "<cmd>Telescope autocommands<cr>", desc = "🔄 オートコマンド (Auto Commands)" },
